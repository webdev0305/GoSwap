...
export default function SwapModalHeader({
  ...
  return (
    <AutoColumn gap="md">
      <div style={{background:"#273043",borderRadius:"16px",padding:"15px"}}>
        <Text small color="#8B95A8">From</Text>
      ...
      <div style={{background:"#273043",borderRadius:"16px",padding:"15px"}}>
        <Text small color="#8B95A8">To</Text>
        <RowBetween align="flex-end">
          <RowFixed gap="0px">
            <TruncatedText
              fontSize="24px"
      ...
      <AutoColumn justify="flex-start" gap="sm">
        <Text small color="#8B95A8" textAlign="left" style={{ width: '100%' }}>
          {estimatedText}
          <b>
            {amount} {symbol}
          </b>
